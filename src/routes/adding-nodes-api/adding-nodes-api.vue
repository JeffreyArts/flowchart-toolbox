<template>
    <div class="adding-nodes-api" @click="updateSelectedNodes" @mousemove="updateSelectedNodes">
        <header class="title">
            <h1>Adding Nodes API</h1>
        </header>
    ...
    mounted() {
        if (this.$el && !this.flowchart) {
            ...
            setTimeout(() => {
                ...
                // const mouseDownDecision1 =  this.flowchart.add({
                ...
                // const mouseDownDecisionYes = this.flowchart.add({
                //     text: "YES",
                //     y: mouseDown.y + 450,
                //     x: mouseDown.x - 250,
                ...
                // const MouseDownDecisionNo = this.flowchart.add({
                //     text: "NO",
                //     y: mouseDown.y + 450,
                //     x: mouseDown.x + 250,
                //     parent: mouseDownDecision1,
                ...
                // const mouseUp = this.flowchart.add({
                //     text: "On Mouse Up",
                //     x: 480,
                //     y: "50",
                //     options: { maxWidth: 320 }
                ...
                // const mouseMove = this.flowchart.add({
                //     text: "On Mouse Move",
                //     x: 480 * 2,
                //     y: "50",
                //     options: { maxWidth: 320 }
                ...
                // const mouseMoveDecision1 = this.flowchart.add({
